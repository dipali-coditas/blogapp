...
if(local_server==True):
    ...
    app.config["SQLALCHEMY_DATABASE_URI"]= "mysql+mysqldb://flaskdb:Exclusive@15@10.102.112.3:3306/flaskdb?unix_socket=/cloudsql/iron-verbena-403909:asia-south1:flaskdb"
